...
| :---: | :---: | :--- | :---: | :---: |
| 1 | Alta | Como [tipo de usuário], quero [funcionalidade] para [motivo] | 5 | 1 |
| 2 | Alta | Como [tipo de usuário], quero [funcionalidade] para [motivo] | 8 | 1 |
| 3 | Média | Como [tipo de usuário], quero [funcionalidade] para [motivo] | 3 | 2 |
| ... | ... | ... | ... | ... |
