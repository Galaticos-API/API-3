  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-base font-bold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        vocedmTeal: "bg-vocedm-teal text-vocedm-blue border border-vocedm-teal hover:opacity-90",
        vocedmSalmon: "bg-vocedm-salmon text-vocedm-blue border border-vocedm-salmon hover:opacity-90",
        vocedmOutlineDark: "bg-transparent text-white border-[1.33px] border-white hover:opacity-90",
        vocedmIcon: "bg-vocedm-teal-dark text-white rounded-full border-none hover:opacity-90",
      },
      size: {
        default: "h-10 px-6 py-2 has-[>svg]:px-4",
        sm: "h-8 rounded-full gap-1.5 px-3 has-[>svg]:px-2.5",
        lg: "h-12 rounded-full px-8 has-[>svg]:px-6",
        icon: "size-10 rounded-full p-2 justify-center",
      },
    },
    defaultVariants: {
      variant: "default",
